...
import { getEmptyCellValue, parseCellKey } from "@workspace/ui/lib/data-grid";
import type { CellUpdate, ContextMenuState } from "@workspace/ui/types/data-grid";
...
function ContextMenuImpl<TData>({
  ...
  return (
    <DropdownMenu open={contextMenu.open} onOpenChange={handleOpenChange}>
