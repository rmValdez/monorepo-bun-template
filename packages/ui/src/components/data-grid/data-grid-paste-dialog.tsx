...
import type { PasteDialogState } from "@workspace/ui/types/data-grid";
    ...
    <Dialog open={pasteDialog.open} onOpenChange={onOpenChange}>
      <DialogContent data-grid-popover="">
        ...
        <div className="flex flex-col gap-3 py-1">
          <label htmlFor="paste-expand-yes" className="flex cursor-pointer items-start gap-3">
            <RadioItem id="paste-expand-yes" ref={expandRadioRef} name="expand-option" value="expand" defaultChecked />
          ...
          <label htmlFor="paste-expand-no" className="flex cursor-pointer items-start gap-3">
            <RadioItem id="paste-expand-no" name="expand-option" value="no-expand" />
            <div className="flex flex-col gap-1">
