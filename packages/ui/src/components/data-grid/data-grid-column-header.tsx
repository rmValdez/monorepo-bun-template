...
import { getColumnVariant } from "@workspace/ui/lib/data-grid";
...
export function DataGridColumnHeader<TData, TValue>({
  ...
  const onTriggerPointerDown: NonNullable<React.ComponentProps<typeof DropdownMenuTrigger>["onPointerDown"]> =
    React.useCallback(
      (event) => {
        onPointerDown?.(event);
