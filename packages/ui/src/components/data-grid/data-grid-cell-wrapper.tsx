...
import { useDataGridPresence } from "@workspace/ui/components/data-grid/data-grid-presence";
import { useComposedRefs } from "@workspace/ui/lib/compose-refs";
import { getCellKey } from "@workspace/ui/lib/data-grid";
import { cn } from "@workspace/ui/lib/utils";
import type { DataGridCellProps } from "@workspace/ui/types/data-grid";
...
export function DataGridCellWrapper<TData>({
  ...
  return (
    <div
      ...
      style={cellPresence ? ({ "--tw-ring-color": cellPresence.color } as React.CSSProperties) : undefined}
      onClick={onClick}
