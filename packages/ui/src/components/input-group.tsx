/** biome-ignore-all lint/a11y/useSemanticElements: shadcn input-group using div */
/** biome-ignore-all lint/a11y/useKeyWithClickEvents: shadcn input-group using div */
