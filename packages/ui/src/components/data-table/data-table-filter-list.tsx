...
import type { ExtendedColumnFilter, JoinOperator } from "@workspace/ui/types/data-table";
...
export function DataTableFilterList<TData>({
  ...
  const onFilterUpdate = React.useCallback(
    (filterId: string, updates: Partial<Omit<ExtendedColumnFilter<TData>, "filterId">>) => {
      debouncedSetFilters((prevFilters: ExtendedColumnFilter<TData>[]) => {
  ...
  const onFilterRemove = React.useCallback(
    (filterId: string) => {
      const updatedFilters = filters.filter((filter: ExtendedColumnFilter<TData>) => filter.filterId !== filterId);
  ...
  return (
    ...
    >
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger>
          <Button variant="outline" className="font-normal" onKeyDown={onTriggerKeyDown} disabled={disabled}>
...
function DataTableFilterItem<TData>({
  ...
  return (
    <SortableItem value={filter.filterId}>
      ...
      >
        <div className="min-w-[72px] text-center">
          {index === 0 ? (
            ...
            <Select
              value={joinOperator}
              onValueChange={(value: string | null) => setJoinOperator((value as JoinOperator) ?? "and")}
            >
              <SelectTrigger
              ...
              <SelectContent id={joinOperatorListboxId} className="min-w-(--radix-select-trigger-width) lowercase">
                <SelectGroup>
        ...
        <Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
          ...
          <PopoverContent id={fieldListboxId} className="w-40 p-0">
            <Command>
        ...
        <Select
          ...
          onValueChange={(value: string | null) =>
            onFilterUpdate(filter.filterId, {
              operator: (value ?? undefined) as typeof filter.operator,
              value: (value === "isEmpty" || value === "isNotEmpty" ? "" : filter.value) as
                | string
                | string[]
                | undefined,
            })
      ...
      return (
        <Input
          ...
          onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
            onFilterUpdate(filter.filterId, {
              value: event.target.value as string | string[] | undefined,
            })
          }
        />
      );
    ...
    case "boolean": {
      ...
      return (
        <Select
          ...
          onValueChange={(value: string | null) =>
            onFilterUpdate(filter.filterId, {
              value: (value ?? undefined) as string | string[] | undefined,
            })
          }
        >
          <SelectTrigger
    ...
    case "dateRange": {
      ...
      return (
        <Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
          ...
          <PopoverContent id={inputListboxId} className="w-auto p-0">
            {filter.operator === "isBetween" ? (
              <Calendar
                ...
                onSelect={(date: import("react-day-picker").DateRange | undefined) => {
                  onFilterUpdate(filter.filterId, {
                    value: date
