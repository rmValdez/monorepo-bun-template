...
export function DataTableFilterMenu<TData>({
  ...
  return (
    <ul className="flex flex-wrap items-center gap-2">
      {filters.map((filter: ExtendedColumnFilter<TData>) => (
        <DataTableFilterItem
          key={filter.filterId}
          filter={filter}
      ...
      <Popover open={open} onOpenChange={onOpenChange}>
        ...
        <PopoverContent
          className={cn("w-full max-w-(--radix-popover-content-available-width) p-0", className)}
          {...props}
        >
              ...
              {selectedColumn ? (
                <>
                  ...
                  <FilterValueSelector
                    ...
                    value={inputValue}
                    onSelect={(value: string) => onFilterAdd(selectedColumn, value)}
                  />
                </>
              ) : (
                <>
    ...
    case "boolean": {
      ...
      return (
        <Select
          ...
          onValueChange={(value: string | null) =>
            onFilterUpdate(filter.filterId, { value: (value ?? undefined) as string | string[] | undefined })
          }
        >
          <SelectTrigger
            id={inputId}
    ...
    case "multiSelect": {
      ...
      return (
        <Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
          ...
          <PopoverContent id={inputListboxId} className="w-48 p-0">
            <Command>
